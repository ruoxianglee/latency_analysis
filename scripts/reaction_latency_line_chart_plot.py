...
def line_chart_plot_different_channels(results):
    ...
    # Save the chart
    plt.savefig('./reaction_latency_different_channels_1.svg', format='svg')
...
def line_chart_plot_six_channels(results):
    ...
    # Save the chart
    plt.savefig('./reaction_latency_six_channels.svg', format='svg')
...
def line_chart_plot_varied_delay(results):
    ...
    # Save the chart
    plt.savefig('./reaction_latency_varied_delay_1.svg', format='svg')
...
def line_chart_plot_period_factor(results):
    ...
    # Save the chart
    plt.savefig('./reaction_latency_period_factor_1.svg', format='svg')
...
def line_chart_plot_varied_period(results):
    ...
    # Save the chart
    plt.savefig('./reaction_latency_varied_period_1.svg', format='svg')
